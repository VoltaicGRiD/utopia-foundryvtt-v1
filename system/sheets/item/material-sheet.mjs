...
export class UtopiaArtificeMaterialSheet extends api.HandlebarsApplicationMixin(sheets.ItemSheetV2) {
  constructor(options = {}) {
    super(options);
  }

  static DEFAULT_OPTIONS = {
    classes: ["utopia", "artifice-material-sheet"],
    position: {
      width: 600,
      height: "auto",
    },
  ...
  static PARTS = {
    ...
    attributes: {
      template: "systems/utopia/templates/item/artifice/material/attributes.hbs",
    },
  };
