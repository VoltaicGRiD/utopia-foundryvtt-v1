...
export class UtopiaConsumableSheet extends api.HandlebarsApplicationMixin(
  sheets.ItemSheetV2
) {
  constructor(options = {}) {
    super(options);
  ...
  static DEFAULT_OPTIONS = {
    ...
    window: {
      title: "UTOPIA.SheetLabels.consumable",
    },
  };
  ...
  static PARTS = {
    ...
    attributes: {
      template: "systems/utopia/templates/item/gear/consumable.hbs",
