...
export default class UtopiaTwitchIntegrationSheet extends api.HandlebarsApplicationMixin(api.ApplicationV2) {
  ...
  static PARTS = {
    ...
    settings: {
      template: "systems/utopia/templates/extensions/twitch-integration/settings.hbs",
      scrollable: ['']
    },
    // chat: {
    //   template: "systems/utopia/templates/extensions/twitch-integration/chat.hbs",
    // },
    commands: {
      template: "systems/utopia/templates/extensions/twitch-integration/commands.hbs",
    },
  };
