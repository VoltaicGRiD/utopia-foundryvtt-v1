...
export class UtopiaFeatureBuilder extends api.HandlebarsApplicationMixin(api.ApplicationV2) {
  constructor(options = {}) {
    super(options);
    this.advanced = false;
  ...
  static PARTS = {
    content: {
      template: "systems/utopia/templates/other/feature-builder/builder.hbs",
