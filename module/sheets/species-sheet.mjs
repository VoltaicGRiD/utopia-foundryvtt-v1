...
export class UtopiaSpeciesSheet extends api.HandlebarsApplicationMixin(
  ...
  static PARTS = {
    header: {
      template: "systems/utopia/templates/species/header.hbs",
    },
    tabs: {
      template: "templates/generic/tab-navigation.hbs",
    },
    attributes: {
      template: "systems/utopia/templates/species/attributes.hbs",
    },
    description: {
      template: "systems/utopia/templates/species/description.hbs",
    },
  };
