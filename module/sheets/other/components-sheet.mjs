...
export class UtopiaActorComponentsSheet extends api.HandlebarsApplicationMixin(sheets.ActorSheetV2) {
  ...
  async _prepareContext(options) {
    const components = this.actor.system.components;
